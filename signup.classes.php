...
protected function checkEmail($email) {
    ...
    protected function setUser($uid,$pwd,$email/* ,$city */,$address) {

        $stmt=$this->connect()->prepare("INSERT INTO users(users_uid,users_pwd,users_email/* ,users_city */,users_address) VALUES (?,?,?/* ,? */,?);");

        $hashedPwd=password_hash($pwd,PASSWORD_DEFAULT);

        if(!$stmt->execute(array($uid,$hashedPwd,$email/* ,$city */,$address))) {
